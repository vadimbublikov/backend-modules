package tech.cmodule.store.notification.impl.config
...
@Configuration
class NotificationLiquibaseConfig {
    @Bean
    fun notificationLiquibase(
        dataSource: ObjectProvider<DataSource>,
        properties: LiquibaseProperties
    ): SpringLiquibase {
        val liquibase = SpringLiquibase()
        liquibase.dataSource = dataSource.ifAvailable
        liquibase.changeLog = "classpath:db/changelog-notification.xml"
